...
public class Donation extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.settings:
                Intent intent = new Intent(Donation.this, Settings.class);
            ...
            case R.id.donationhis:
                ...
                break;
            case R.id.help:
                Intent intent2 = new Intent(Donation.this, Help.class);
                startActivity(intent2);
                break;
            case R.id.info:
                Intent intent1 = new Intent(Donation.this, Information.class);
