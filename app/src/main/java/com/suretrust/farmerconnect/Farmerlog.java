...
public class Farmerlog extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_farmerlog);
        ...
        mv=findViewById(R.id.imageArrowleft);
        ...
        mv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(Farmerlog.this,MainActivity.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.settings:
                Intent intent = new Intent(Farmerlog.this, Settings.class);
                startActivity(intent);
                break;
            case R.id.donationhis:
                Intent intent1 = new Intent(Farmerlog.this, Donation.class);
                startActivity(intent1);
                break;
            case R.id.help:
                Intent intent3 = new Intent(Farmerlog.this, Help.class);
                startActivity(intent3);
                break;
            case R.id.info:
                Intent intent2 = new Intent(Farmerlog.this, Information.class);
